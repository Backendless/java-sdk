...
class GeneralMessaging implements Messaging
{
  final static String MESSAGING_MANAGER_SERVER_ALIAS = "com.backendless.services.messaging.MessagingService";
  final static String EMAIL_MANAGER_SERVER_ALIAS = "com.backendless.services.mail.CustomersEmailService";
  final static String EMAIL_TEMPLATE_SENDER_SERVER_ALIAS = "com.backendless.services.mail.EmailTemplateSender";
  ...
  {
    throw new UnsupportedOperationException( ExceptionMessage.NOT_ANDROID );
  }
  ...
  {
    return Invoker.invokeSync( DeviceRegistrationUtil.getDeviceRegistrationManagerServerAlias(), "refreshDeviceToken", new Object[] { prefs.getDeviceId(), newDeviceToken } );
  }
  ...
  {
    return Invoker.invokeSync( DeviceRegistrationUtil.getDeviceRegistrationManagerServerAlias(), "getDeviceRegistrationByDeviceId", new Object[] { prefs.getDeviceId() } );
  }
  ...
  public void sendEmailFromTemplate( String templateName, EmailEnvelope envelope, List<String> attachments,
                                     AsyncCallback<MessageStatus> responder )
  {
